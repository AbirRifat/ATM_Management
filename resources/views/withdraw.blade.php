...
<body>
    <div class="container">
        <div class="card">
            ...
            <form action="{{ route('withdraw') }}" method="POST" class="p-4">
                @csrf
                <!-- Hidden user_id (using Auth to get the user ID) -->
                <input type="hidden" name="user_id" value="{{ Auth::id() }}">

                <!-- Remaining Balance -->
                <div class="mb-3">
                    <label for="remaining-balance" class="form-label">Your Remaining Balance</label>
                    <input type="text" class="form-control remaining-balance" id="remaining-balance" value="{{ number_format($balance, 2) }}" readonly>
                </div>
                ...
                <div class="mb-3">
                    <label for="display-amount" class="form-label">Amount to Withdraw</label>
                    <input type="text" class="form-control" id="display-amount" name="display_amount" placeholder="Enter amount">
                </div>
